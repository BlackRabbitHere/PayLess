...
public record Offer(String externalKey, String provider, String merchant, String title,
        ...
        BigDecimal minimumTransaction, List<String> eligibleIssuers, List<String> eligibleInstrumentTypes, List<String> eligibleNetworks,
    ...
    public Offer {
        ...
        eligibleNetworks = List.copyOf(eligibleNetworks);
