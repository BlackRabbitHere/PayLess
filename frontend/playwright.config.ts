...
export default defineConfig({
  ...
  webServer: [
    ...
    { command: 'java -jar ../backend/target/payment-optimizer-0.0.1-SNAPSHOT.jar', url: 'http://127.0.0.1:18080/actuator/health', reuseExistingServer: false, timeout: 60000,
      env: { PORT: '18080', SPRING_PROFILES_ACTIVE: 'local', SCRAPER_BASE_URL: 'http://127.0.0.1:18000', DATABASE_URL: process.env.DATABASE_URL ?? 'jdbc:postgresql://127.0.0.1:15432/payment_optimizer', CORS_ALLOWED_ORIGINS: baseURL } },
